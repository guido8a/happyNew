                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                <label class="btn btn-primary toggle active" data-tipo="tipo" data-valor="general" data-reporte="${reporte}">
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                <label class="btn btn-primary toggle active" data-tipo="formato" data-valor="PDF" data-reporte="${reporte}">

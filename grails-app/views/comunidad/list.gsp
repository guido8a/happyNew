...
<html>
    <head>
        ...
        <title>Lista de Comunidad</title>
    </head>
    <body>
    ...
    <!-- botones -->
        ...
        <table class="table table-condensed table-bordered table-striped">
            ...
            <tbody>
                <g:each in="${comunidadInstanceList}" status="i" var="comunidadInstance">
                    <tr data-id="${comunidadInstance.id}">
        ...
        <elm:pagination total="${comunidadInstanceCount}" params="${params}"/>

        <script type="text/javascript">
            var id = null;
            function submitForm() {
                var $form = $("#frmComunidad");
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Comunidad seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",

    ...
    <g:form class="form-horizontal" name="frmParametros" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: parametrosInstance, field: 'horaFin', 'error')} required">
            <span class="grupo">
                ...
                %{--<div class="col-md-2">--}%
                %{--<g:field name="horaFin" type="number" value="${parametrosInstance.horaFin}" class="digits form-control required" required=""/>--}%
                %{--</div>--}%

                %{--<div class="col-md-2">--}%
                %{--<g:field name="minutoFin" type="number" value="${parametrosInstance.minutoFin}" class="digits form-control required" required=""/>--}%
                %{--</div>--}%
                %{--*--}%
            </span>
        </div>

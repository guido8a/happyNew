...
//                $(".annoying").show("pulsate")
        setInterval(function () {
            $(".annoying").hide()
            setTimeout(function(){ $(".annoying").show()},500)
            setTimeout(function(){ $(".annoying").hide()},1000)
            setTimeout(function(){ $(".annoying").show()},1500)
            setTimeout(function(){ $(".annoying").hide()},2000)
            setTimeout(function(){ $(".annoying").show()},2500)
            setTimeout(function(){ $(".annoying").hide()},3000)
            setTimeout(function(){ $(".annoying").show()},3500)
            setTimeout(function(){ $(".annoying").hide()},4000)
            setTimeout(function(){ $(".annoying").show()},4500)
            setTimeout(function(){ $(".annoying").hide()},5000)
            setTimeout(function(){ $(".annoying").show()},5500)
            setTimeout(function(){ $(".annoying").hide()},6000)
            setTimeout(function(){ $(".annoying").show()},6500)
            setTimeout(function(){ $(".annoying").hide()},7000)
            setTimeout(function(){ $(".annoying").show()},7500)
            setTimeout(function(){ $(".annoying").hide()},8000)
            setTimeout(function(){ $(".annoying").show()},8500)
        },60000);

            ...
            <tbody>
                <g:each in="${procesoInstanceList}" status="i" var="procesoInstance">
                    <tr data-id="${procesoInstance.id}">
                        ...
                        <td>${fieldValue(bean: procesoInstance, field: "tipoProceso")}</td>
                        
                        <td>${fieldValue(bean: procesoInstance, field: "nombre")}</td>
                        
                        <td>${fieldValue(bean: procesoInstance, field: "descripcion")}</td>
                        
                        <td>${fieldValue(bean: procesoInstance, field: "numero")}</td>
                        
                        <td>${fieldValue(bean: procesoInstance, field: "tiempo")}</td>
                        
                        <td><g:formatDate date="${procesoInstance.fecha}" format="dd-MM-yyyy" /></td>

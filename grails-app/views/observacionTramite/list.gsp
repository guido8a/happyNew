...
<html>
    <head>
        ...
        <title>Lista de ObservacionTramite</title>
    </head>
    <body>
    ...
    <!-- botones -->
        ...
        <elm:pagination total="${observacionTramiteInstanceCount}" params="${params}"/>

        <script type="text/javascript">
            var id = null;
            function submitForm() {
                var $form = $("#frmObservacionTramite");
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el ObservacionTramite seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
                ...
                $.ajax({
                    ...
                    success : function (msg) {
                        var b = bootbox.dialog({
                            id      : "dlgCreateEdit",
                            title   : title + " ObservacionTramite",
                            message : msg,
                            buttons : {
                                cancelar : {
                                    label     : "Cancelar",
                        ...
                        ver      : {
                            ...
                            action : function ($element) {
                                ...
                                $.ajax({
                                    ...
                                    success : function (msg) {
                                        bootbox.dialog({
                                            title   : "Ver Observación de Trámite",
                                            message : msg,
                                            buttons : {
                                                ok : {
                                                    label     : "Aceptar",

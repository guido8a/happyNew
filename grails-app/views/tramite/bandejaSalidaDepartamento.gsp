...
<html>
    <head>
        ...
        <title>Bandeja de Salida Departamento</title>
            ...
            <span class="grupo">
                ...
                <div id="alertaNoRecibidos">
                    <div data-type="noRecibido" class="alert alert-danger alertas"
                         style="padding-left: 30px; padding-top: 10px; width: 150px"><label class="etiqueta">No recibido</label>
                    </div>
                </div>
...
//        });
            ...
            function cargarBandeja() {
                ...
                var datos = ""
                $.ajax({type : "POST", url : "${g.createLink(controller: 'tramite',action:'tablaBandejaSalidaDepartamento')}",
                    data     : datos,
                    success  : function (msg) {

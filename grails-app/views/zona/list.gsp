...
<html>
    ...
    <!-- botones -->
        ...
        <elm:pagination total="${zonaInstanceCount}" params="${params}"/>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Zona seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",

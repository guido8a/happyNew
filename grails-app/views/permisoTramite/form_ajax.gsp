    ...
    <g:form class="form-horizontal" name="frmPermisoTramite" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: permisoTramiteInstance, field: 'codigo', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="codigo" maxlength="4" required="" class="form-control required" value="${permisoTramiteInstance?.codigo}"/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group ${hasErrors(bean: permisoTramiteInstance, field: 'descripcion', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="descripcion" maxlength="63" required="" class="form-control required" value="${permisoTramiteInstance?.descripcion}"/>
                </div>
                 *
            </span>
        </div>

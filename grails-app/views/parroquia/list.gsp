...
<html>
    <head>
        ...
        <title>Lista de Parroquia</title>
    </head>
    <body>
    ...
    <!-- botones -->
        ...
        <table class="table table-condensed table-bordered table-striped">
            ...
            <tbody>
                <g:each in="${parroquiaInstanceList}" status="i" var="parroquiaInstance">
                    <tr data-id="${parroquiaInstance.id}">
        ...
        <elm:pagination total="${parroquiaInstanceCount}" params="${params}"/>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Parroquia seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",

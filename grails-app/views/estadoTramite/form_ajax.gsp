    ...
    <g:form class="form-horizontal" name="frmEstadoTramite" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: estadoTramiteInstance, field: 'codigo', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="codigo" maxlength="4" required="" class="form-control required" value="${estadoTramiteInstance?.codigo}"/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group ${hasErrors(bean: estadoTramiteInstance, field: 'descripcion', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="descripcion" maxlength="31" required="" class="form-control required" value="${estadoTramiteInstance?.descripcion}"/>
                </div>
                 *
            </span>
        </div>
